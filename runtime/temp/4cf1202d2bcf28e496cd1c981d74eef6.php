                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="1">
                                            <form id="edit-profile" class="form-horizontal" action="<?php echo url('teacher/user/change_major'); ?>" method="post">
                                                <fieldset>

                                                    <div class="control-group">
                                                        <label class="control-label" for="number">工号</label>
                                                        <div class="controls">
                                                    ...
                                                    <script>
                                                        $(function () {
                                                            ...
                                                            $("#major").change(function () {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",  //提交方式
                                                                    url: "<?php echo url('teacher/user/ajax_department'); ?>",//路径
                                        ...
                                        <div class="tab-pane" id="2">
                                            <form id="edit-profile2" class="form-horizontal" method="post" action="<?php echo url('teacher/user/password'); ?>">
                                                <fieldset>
                                                    <div class="control-group">
                                        ...
                                        <div class="tab-pane" id="3">
                                            <form id="edit-profile3" action="<?php echo url('teacher/user/contact'); ?>" method="post" class="form-horizontal">
                                                <fieldset>
