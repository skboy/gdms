<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"G:\AppServ\www\gdms\application/../template/admin\department\add_edit_department.html";i:1519188467;s:66:"G:\AppServ\www\gdms\application/../template/admin\public\link.html";i:1512299457;s:68:"G:\AppServ\www\gdms\application/../template/admin\public\header.html";i:1519143595;s:66:"G:\AppServ\www\gdms\application/../template/admin\public\left.html";i:1519187460;s:68:"G:\AppServ\www\gdms\application/../template/admin\public\footer.html";i:1514995332;s:64:"G:\AppServ\www\gdms\application/../template/admin\public\js.html";i:1512299499;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                            ...
                            <form id="edit-profile" method="post" class="form-horizontal" style="margin-top: 20px">
                                ...
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label" for="name">系别</label>
                                        <div class="controls">
                                            <select name="parent_id" id=""style="width: 160px">
                                                ...
                                                <option value="<?php echo $vo['id']; ?>"<?php if($vo['id'] == $department['parent_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <div class="control-group">
                                        <label class="control-label" for="name">专业名字</label>
                                        <div class="controls">
                                            <input type="text" class="input-medium disabled"name="name" id="name"
                                                   value="<?php if(isset($department)): ?><?php echo $department['name']; endif; ?>">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <input type="hidden" class="input-medium disabled"name="id" id="id" value="<?php if(isset($department)): ?><?php echo $department['id']; endif; ?>">
