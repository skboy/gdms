<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"G:\AppServ\www\gdms\application/../template/admin\schedule\add_edit_schedule.html";i:1519290638;s:66:"G:\AppServ\www\gdms\application/../template/admin\public\link.html";i:1512299457;s:68:"G:\AppServ\www\gdms\application/../template/admin\public\header.html";i:1519143595;s:66:"G:\AppServ\www\gdms\application/../template/admin\public\left.html";i:1519290134;s:68:"G:\AppServ\www\gdms\application/../template/admin\public\footer.html";i:1519279161;s:64:"G:\AppServ\www\gdms\application/../template/admin\public\js.html";i:1512299499;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="input-medium disabled"name="name" id="name"
                                                   value="<?php if(isset($schedule)): ?><?php echo $schedule['name']; endif; ?>">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <div class="control-group">
                                        <label class="control-label" for="sort">排序</label>
                                        <div class="controls">
                                            <input type="text" class="input-medium disabled"name="sort" id="sort"
                                                   value="<?php if(isset($schedule)): ?><?php echo $schedule['sort']; else: ?>10<?php endif; ?>"
                                            placeholder="排序越小越靠前">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <input type="hidden" class="input-medium disabled"name="id" id="id"
                                           value="<?php if(isset($schedule)): ?><?php echo $schedule['id']; endif; ?>">
