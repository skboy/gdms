<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:88:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\student\student_list.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\link.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\header.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\left.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\footer.html";i:1521770391;s:77:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\js.html";i:1521770391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <div class="stat-container">
                    ...
                    <div class="widget widget-table">
                        <form class="faq-search">
                            <input type="text" name="keywords" placeholder="请输入要搜索的学生姓名或者学号">
                        </form>
                        <div class="widget-header">
                            <i class="icon-user"></i>
                            <h3>列表</h3>

                         <!--   <a href="<?php echo url('/admin/add_edit_student'); ?>" class="btn btn-small"
                               style="float: right;margin-right: 25px;margin-top: 5px">
                                添加
                            </a>-->
                            <a href="<?php echo url('/admin/student_import'); ?>" class="btn btn-small"style="float: right;margin-right: 25px;margin-top: 5px">
                                导入
                            </a>
                        </div> <!-- /widget-header -->
                        ...
                        <div class="widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo get_major_name($vo['major']); ?></td>
                                    <td><?php echo get_department_name($vo['department']); ?></td>
                                    <td class="action-td">
                                        <a href="<?php echo url('/admin/edit_student',['user_id'=>$vo['user_id']]); ?>"
                                           class="btn btn-small btn-warning">
                                           修改密码
                                        </a>

                                        <a href="<?php echo url('/admin/del_student',['user_id'=>$vo['user_id']]); ?>"
                                           class="btn btn-small">
                                            删除
                                        </a>
                                    </td>
