							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" method="post"/>
									<fieldset>
										...
										<div class="control-group">
											<label class="control-label">所选学生:</label>
											<div class="controls">
												<p><?php if($article['student_id'] == 0): ?>未选择<?php else: ?><?php echo $student['name']; endif; ?></p>
											</div> <!-- /controls -->
										</div> <!-- /control-group -->
										<div class="control-group">
											<label class="control-label">进度:</label>
											<div class="controls">
												<p><?php echo $article['schedule']; ?></p>
											</div> <!-- /controls -->
										</div> <!-- /control-group -->
										<div class="control-group">
											...
											<div class="controls">
												<p>
													<?php if($article['proposal'] != ''): ?>
													<a href="<?php echo $article['proposal']; ?>"><?php echo $article['proposal_name']; ?></a>
													<?php else: ?>
													未上传
													<?php endif; ?>
												</p>
										...
										<div class="control-group">
											...
											<div class="controls">
												<p>
													<?php if($article['thesis'] != ''): ?>
													<a href="<?php echo $article['thesis']; ?>"><?php echo $article['thesis_name']; ?></a>
													<?php else: ?>
													未上传
													<?php endif; ?>
												</p>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<textarea type="text" class="" name="content"style="width: 450px;height:100px;" ></textarea>
												<?php else: ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" class="" name="point"id="point"value="" style="width: 450px"/>
												<?php else: ?>
