<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\user\info.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\link.html";i:1521770391;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\header.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\left.html";i:1521770391;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\footer.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\js.html";i:1521770391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                                        ...
                                        <form id="edit-profile" class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="username">导师姓名</label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="input-medium disabled"
                                                               id="phone" value="<?php echo $user['phone']; ?>" disabled="">
                                                    </div> <!-- /controls -->
                                                </div> <!-- /control-group -->
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="input-medium disabled"
                                                               id="qq" value="<?php echo $user['qq']; ?>" disabled="">
                                                    </div> <!-- /controls -->
                                                </div> <!-- /control-group -->
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="input-medium disabled"
                                                               id="wechat" value="<?php echo $user['wechat']; ?>" disabled="">
                                                    </div> <!-- /controls -->
                                                </div> <!-- /control-group -->
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="input-medium disabled"
                                                               id="email" value="<?php echo $user['email']; ?>" disabled="">
                                                    </div> <!-- /controls -->
                                                </div> <!-- /control-group -->
