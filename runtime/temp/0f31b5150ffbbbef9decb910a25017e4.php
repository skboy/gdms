<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\rank\index.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\link.html";i:1521770391;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\header.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\left.html";i:1521770391;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\footer.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/student\public\js.html";i:1521770391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="row">
                        ...
                        <div class="span3">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <h3>专业排行</h3>
                                    <?php if($department_rank == null): ?>
                                    暂无排行
                                    <?php else: if(is_array($department_rank) || $department_rank instanceof \think\Collection || $department_rank instanceof \think\Paginator): if( count($department_rank)==0 ) : echo "" ;else: foreach($department_rank as $key=>$vo): ?>
                                    <div style="overflow: hidden;margin-bottom: 10px">
                                        <div class="account-avatar" style="float: left;">
                                            <img src="<?php echo get_avatar($vo['user_id']); ?>" alt="" class="thumbnail">
                                        </div> <!-- /account-avatar -->
                        ...
                        <div class="span3">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <h3>系排行</h3>
                                    <?php if($major_rank == null): ?>
                                    暂无排行
                                    <?php else: if(is_array($major_rank) || $major_rank instanceof \think\Collection || $major_rank instanceof \think\Paginator): if( count($major_rank)==0 ) : echo "" ;else: foreach($major_rank as $key=>$vo): ?>
                                    <div style="overflow: hidden;margin-bottom: 10px">
                                        <div class="account-avatar" style="float: left;">
                                            <img src="<?php echo get_avatar($vo['user_id']); ?>" alt="" class="thumbnail">
                                        </div> <!-- /account-avatar -->
                        ...
                        <div class="span3">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <h3>全校排行</h3>
                                    <?php if($all_rank == null): ?>
                                    暂无排行
                                    <?php else: if(is_array($all_rank) || $all_rank instanceof \think\Collection || $all_rank instanceof \think\Paginator): if( count($all_rank)==0 ) : echo "" ;else: foreach($all_rank as $key=>$vo): ?>
                                    <div style="overflow: hidden;margin-bottom: 10px">
                                        <div class="account-avatar" style="float: left;">
                                            <img src="<?php echo get_avatar($vo['user_id']); ?>" alt="" class="thumbnail">
                                        </div> <!-- /account-avatar -->
