...
<div class="loading" aria-label="Loading" role="img" tabindex="-1"></div>
			...
			<div class="span9">
				...
				<div class="stat-container">
					...
					<div class="widget">
						<a href="<?php echo url('/teacher/message_list',array('student_id'=>$vo['student_id'])); ?>">
