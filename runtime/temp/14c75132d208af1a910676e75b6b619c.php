<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/teacher\notice\index.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/teacher\public\link.html";i:1521770391;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/teacher\public\header.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/teacher\public\left.html";i:1528438841;s:83:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/teacher\public\footer.html";i:1521770391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="span3">
    ...
    <ul id="main-nav" class="nav nav-tabs nav-stacked">
        ...
        <li class="<?php if(($action == "schedule_list")): ?>active<?php endif; ?>">
...
<div class="loading" aria-label="Loading" role="img" tabindex="-1"></div>
            ...
            <div class="span9">
                ...
                <a href="<?php echo url('/teacher/notice_add_edit'); ?>" class="btn"style="margin-bottom: 10px">添加公告</a>

                <?php if(is_array($notice_list) || $notice_list instanceof \think\Collection || $notice_list instanceof \think\Paginator): $i = 0; $__LIST__ = $notice_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <div class="widget">
                            <div class="widget-content">
                               <a href="<?php echo url('/teacher/notice_detail',array('notice_id'=>$vo['notice_id'])); ?>"style="clear: both">
                                   <h3>
                                ...
                                <a href="javascript:(0)" class="delete" notice_id="<?php echo $vo['notice_id']; ?>"style="float: right;margin-left: 10px">删除</a>
                                <a href="<?php echo url('/teacher/notice_add_edit',array('notice_id'=>$vo['notice_id'])); ?>"style="float: right;margin-left: 10px">修改</a>
                                <a href="<?php echo url('/teacher/notice_detail',array('notice_id'=>$vo['notice_id'])); ?>"style="float: right">查看</a>
                            </div> <!-- /widget-content -->
                        </div> <!-- /widget -->
...
$(function () {
    $('.delete').click(function () {
        ...
        if(confirm("确定删除该公告?")){
            window.location.href='/teacher/Notice/delete?notice_id='+notice_id;
        }
    })
})
</script>
