<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:94:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\department\department_list.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\link.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\header.html";i:1521770391;s:79:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\left.html";i:1521770391;s:81:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\footer.html";i:1521770391;s:77:"D:\phpStudy\PHPTutorial\WWW\gdms\application/../template/admin\public\js.html";i:1521770391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <div class="stat-container">
                    ...
                    <div class="widget widget-table">
                        ...
                        <div class="widget-header">
                            <i class="icon-th-list"></i>
                            <h3>列表</h3>
                            <a href="<?php echo url('/admin/add_edit_department'); ?>" class="btn btn-small"style="float: right;margin-right: 25px;margin-top: 5px">
                            添加
                        </a>
                        </div> <!-- /widget-header -->
                        ...
                        <div class="widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php if(is_array($major_department) || $major_department instanceof \think\Collection || $major_department instanceof \think\Paginator): if( count($major_department)==0 ) : echo "" ;else: foreach($major_department as $key=>$vo): if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection || $vo['child'] instanceof \think\Paginator): if( count($vo['child'])==0 ) : echo "" ;else: foreach($vo['child'] as $key=>$vv): ?>
                                <tr>
                                    ...
                                    <td class="action-td">
                                       <a href="<?php echo url('/admin/add_edit_department',['id'=>$vv['id']]); ?>" class="btn btn-small btn-warning">
                                           编辑
                                        </a>

                                        <a href="<?php echo url('/admin/del_department',['id'=>$vv['id']]); ?>" class="btn btn-small">
                                            删除
                                        </a>
                                    </td>
                                </tr>
